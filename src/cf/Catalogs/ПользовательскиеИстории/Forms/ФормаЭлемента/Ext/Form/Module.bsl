...
Процедура ОбновитьПодсказку()
	...
	Если ЗначениеЗаполнено(Объект.НеобходимыйФункционал) Тогда
		Текст = СтрЗаменить(Текст, "#НеобходимаяФункциональность", "<strong>" + Объект.НеобходимыйФункционал + "</strong>");		
	Иначе
...
Процедура ОбновитьЗаголовокФункционала(Автоматически = Ложь)
	Если Автоматически Тогда
		Объект.Заголовок = "[" + Объект.НеобходимыйФункционал + "] " + Объект.КлючевоеДействие;
